    ...
    nextToken: function() {
        while (true) {
            ...
            try {
                ...
                Karishma 03.04.14 fixing comments for clarity.
                This is the original ANTLR 3.3 JS Target code,
                Corrado Campisano patched this original piece of code below.
                ...
                */
                //Karishma 03.04.14 ... fixing comments for clarity. 
                //This commented out code is the Corrado Campison Patch. 
                //I patched this patch, below.
                ...
                //     throw re;
                // }
                //Patched by Karishma 01.15.14 as seen on this link: http://www.antlr.org/wiki/pages/viewpage.action?pageId=5341230
                this.reportError(re);
                if (re instanceof org.antlr.runtime.NoViableAltException) {
                    this.recover(re);
                }
                var t = new org.antlr.runtime.CommonToken(this.input, org.antlr.runtime.Token.INVALID_TOKEN_TYPE, org.antlr.runtime.Token.DEFAULT_CHANNEL, this.state.tokenStartCharIndex, this.getCharIndex()-1);
