 ...
 * 
 *   [lyn, 2015 Jun 08]: 
 *   + Change log and error divs to have items with distinct css (in new file ai1Convert.css).
 */ 
...
function log(msg) {
  ...
  logItem.setAttribute("class", "log_item");
...
function processAI1SourceFile () {
  ...
  getZippedEntries(AI1SourceFile, function(entries) {
      ...
      log(AI1SourceEntries.length + " files to convert:<br>" + AI1SourceEntries.map(function(entry) { return entry.filename; }).join("<br>") + "<br>");
            ...
            if (numberOfFilesConvertedSoFar == numberOfFilesToConvert) { // All files converted
              ...
              if (endsWith(entry.filename, ".blk") || endsWith(entry.filename, ".scm") || endsWith(entry.filename, ".properties")) {
                entry.getData(new zip.TextWriter(), function(AI1FileContents) { // AI1FileContents is just a string
                    log("<br>Contents  of " + AI1Filename + ":\n<br>" + prettifyContents(AI1Filename, AI1FileContents) + "<br>");
                    ...
                    AI2Writer.add(AI2Filename, new zip.TextReader(AI2FileContents), function () {
                        ...
                        log("Converted so far: " + numberOfFilesConvertedSoFar 
                            + " out of " + numberOfFilesToConvert
                            + "; filename: " + AI2Filename 
                            + "; file contents:<br>" + prettifyContents(AI2Filename, AI2FileContents));
