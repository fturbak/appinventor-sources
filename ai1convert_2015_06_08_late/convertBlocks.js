 ...
 * Lyn Turbak, July 6-18 2014, May 25-27 2015, Jun ?? - 08 2015. 
 */
...
{"number": {"kind": "leaf", "type": "math_number", "fieldName": "NUM"}, 
 ...
 "string-append": {"kind": "inlineBinopToMutator", "type":"text_join", "numItemsName":"items", "randName":"ADD"},
 "string-vappend": {"kind": "expOpExtensible", "type":"text_join", "numItemsName":"items", "randName":"ADD"},
 ...
 "string-equal": {"kind": "inlineBinop", "type":"text_compare", "opFieldName":"OP", "opFieldValue": "EQUAL", "randNames": ["TEXT1", "TEXT2"]},
 "string-greater-than": {"kind": "inlineBinop", "type":"text_compare", "opFieldName":"OP", "opFieldValue": "GT", "randNames": ["TEXT1", "TEXT2"]},
 "string-less-than": {"kind": "inlineBinop", "type":"text_compare", "opFieldName":"OP", "opFieldValue": "LT", "randNames": ["TEXT1", "TEXT2"]},
 "string-length": {"kind": "expOp", "type":"text_length", "randNames": ["VALUE"]},
 "string-starts-at": {"kind": "expOp", "type":"text_starts_at", "opFieldName":"OP", "opFieldValue": "DOWNCASE", "randNames": ["TEXT", "PIECE"]},
 "string-trim": {"kind": "expOp", "type":"text_trim", "randNames": ["TEXT"]},
 "yail-equal": {"kind": "inlineBinop", "type":"logic_compare", "opFieldName":"OP", "opFieldValue": "EQ", "randNames": ["A", "B"]},
...
/* 
// Use reportError from ai1ConvertZip.js instead
