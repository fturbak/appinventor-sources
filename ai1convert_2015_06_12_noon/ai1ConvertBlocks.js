...
function convertGenericComponentGetter(id, block, spec, resultBlock, maps) {
  /* AI:
   ...
   => AI2: 
     <block type="component_set_get" id="286" inline="false">
...
function convertOperator(id, block, spec, resultBlock, maps) {
  ...
  */
  ...
  // Last, convert the expandable sockets (if they exist, as in make-list, add-items-to-list, number-max, 
