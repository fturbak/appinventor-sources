...
function reportError(msg) {
  ...
  errorItem.appendChild(goog.dom.createTextNode("Error from screen " + currentScreenName + ": " + msg));
}
...
function reportWarning(msg) {
  ...
  warningItem.appendChild(goog.dom.createTextNode("Warning from screen " + currentScreenName + ": " + msg));
}
...
function processAI1SourceFile () {
  ...
  getZippedEntries(AI1SourceFile, function(entries) {
      ...
      if (!endsWith(AI1SourceFilename, ".zip")) {
          reportError("AI1 project source file names end in .zip . " 
