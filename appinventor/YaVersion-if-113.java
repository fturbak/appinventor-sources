...
git fetch ssh://lyn@gerrit.appinventor.mit.edu:29418/app-inventor-private refs/changes/99/1099/11 && git checkout FETCH_HEAD
  ...
  // - BLOCKS_LANGUAGE_VERSION incremented to 18
  ...
  // - Third test of new upgrading architecture: Hal's if expression mutator. 
  ...
  // - New Obsfucate Text Block was added (Jeff)
  // For BLOCKS_LANGUAGE_VERSION 19:
  // - Added the expression form of If (Hal)
