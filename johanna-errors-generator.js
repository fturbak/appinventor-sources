...
Blockly.CodeGenerator.prototype.blockToCode = function(block) {
  ...
  //var code = "(augment " + block.id + " " + func.call(block) + ")";
  console.log("BLOCK TO CODE new"); //JOHANNA
  console.log("code " + code);
  if (code instanceof Array) {
    // Value blocks return tuples of code and operator order.
    console.log("INSTANCE OF ARRAY");
    console.log("Input code: [" + [this.scrub_(block, code[0]), code[1]] + "]");
...
Blockly.CodeGenerator.prototype.valueToCode = function(block, name, order) {
  ...
  console.log(block.id + " " + name +  " " + order); //JOHANNA
  if (isNaN(order)) {
