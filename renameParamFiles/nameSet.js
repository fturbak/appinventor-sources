 ...
 * size of the set.
 * @param renaming: a dictionary (i.e. object) mapping old names to new names
 *
 */
Blockly.NameSet.prototype.rename = function(renaming) {
  this.mirror(this.renamed(renaming));
}
 ...
 */
Blockly.NameSet.prototype.renamed = function(renaming) {
  var result = new Blockly.NameSet();
  for (var elt in this.elements) {
    var renamedElt = renaming[elt];
    if (renamedElt) {
