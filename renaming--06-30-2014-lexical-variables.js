...
Blockly.Language.local_declaration_statement = {
  ...
  updateDeclarationInputs_: function(names, inits) {
    ...
    // [lyn, 11/24/13] stop rendering until block is recreated
    ...
    // [lyn, 11/24/13] rerender after changes made
  ...
  freeVariables: function() { // return the free lexical variables of this block
    ...
    var localNames = this.declaredNames();
    result.difference(new Blockly.NameSet(localNames)); // This is LET semantics, not LET* semantics, but should be changed!
