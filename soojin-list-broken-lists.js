...
Blockly.Blocks.['lists_mapOverEach'] = {
  // For each loop.
  category : 'Lists',
  helpUrl : Blockly.Msg.LANG_LISTS_MAPOVEREACH_HELPURL,
  init : function() {
    this.setColour(Blockly.LIST_CATEGORY_HUE);
    //this.setOutput(true, null);
    ...
    this.appendValueInput('LIST')
        .setCheck(Blockly.Blocks.Utilities.YailTypeToBlocklyType("list",Blockly.Blocks.Utilities.INPUT))
        .appendField(Blockly.Msg.LANG_LISTS_MAPOVEREACH_INPUT_ITEM)
        .appendField(new Blockly.FieldParameterFlydown(Blockly.Msg.LANG_LISTS_MAPOVEREACH_INPUT_VAR,
                                                       true, // name is editable
                                                       Blockly.FieldFlydown.DISPLAY_BELOW),
                    'VAR')
        .appendField(Blockly.Msg.LANG_LISTS_MAPOVEREACH_INPUT_INLIST)
        .setAlign(Blockly.ALIGN_RIGHT);
    this.appendDummyInput('EXPRESSION')
        .appendField(Blockly.Msg.LANG_LISTS_MAPOVEREACH_INPUT_EXPRESSION)
        .setAlign(Blockly.ALIGN_RIGHT);
    this.appendIndentedValueInput('DO');
    //.appendField(Blockly.Msg.LANG_LISTS_MAPOVEREACH_INPUT_DO);
    //this.setOutput(true, null);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip(Blockly.Msg.LANG_LISTS_MAPOVEREACH_TOOLTIP);
  },
  ...
  typeblock: [{ translatedName: Blockly.Msg.LANG_LISTS_MAPOVEREACH_INPUT_ITEM }]
};
...
this.setPreviousStatement(true);
this.setNextStatement(true);
Blockly.Language.setTooltip(this, Blockly.Msg.LANG_LISTS_MAPOVEREACH_TOOLTIP);
this.appendCollapsedInput()
.appendField(Blockly.Msg.LANG_LISTS_MAPOVEREACH_INPUT_COLLAPSED_PREFIX
+ ' '   + this.getFieldValue('VAR') + ' '
+ Blockly.Msg.LANG_LISTS_MAPOVEREACH_INPUT_COLLAPSED_SUFFIX,
'COLLAPSED_TEXT');
},
onchange: Blockly.WarningHandler.checkErrors,
getVars: function() {
...
.setText(Blockly.Msg.LANG_LISTS_MAPOVEREACH_INPUT_COLLAPSED_PREFIX
+ ' '   + this.getFieldValue('VAR') + ' '
+ Blockly.Msg.LANG_LISTS_MAPOVEREACH_INPUT_COLLAPSED_SUFFIX);
}
};*/

Blockly.Blocks.['lists_filterOverEach'] = {
  // For each loop.
  category : 'Lists',
  helpUrl : Blockly.Msg.LANG_LISTS_FILTEROVEREACH_HELPURL,
  init : function() {
    this.setColour(Blockly.LIST_CATEGORY_HUE);
    //this.setOutput(true, null);
    // [lyn, 10/07/13] Changed default name from "i" to "item"
    ...
    this.appendValueInput('LIST')
    .setCheck(Blockly.Blocks.Utilities.YailTypeToBlocklyType("list",Blockly.Blocks.Utilities.INPUT))
    .appendField(Blockly.Msg.LANG_LISTS_FILTEROVEREACH_INPUT_ITEM)
    .appendField(new Blockly.FieldParameterFlydown(Blockly.Msg.LANG_LISTS_FILTEROVEREACH_INPUT_VAR,
                                                   true, // name is editable
                                                   Blockly.FieldFlydown.DISPLAY_BELOW),
                 'VAR')
    .appendField(Blockly.Msg.LANG_LISTS_FILTEROVEREACH_INPUT_INLIST)
    .setAlign(Blockly.ALIGN_RIGHT);
    this.appendDummyInput('PREDICATE')
    .appendField(Blockly.Msg.LANG_LISTS_FILTEROVEREACH_INPUT_PREDICATE)
    .setAlign(Blockly.ALIGN_RIGHT);
    this.appendIndentedValueInput('DO');
    //.appendField(Blockly.Msg.LANG_LISTS_FILTEROVEREACH_INPUT_DO);
    //this.setOutput(true, null);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.(Blockly.Msg.LANG_LISTS_FILTEROVEREACH_TOOLTIP);
  },
  // onchange: Blockly.WarningHandler.checkErrors,
  getVars: function() {
    return [this.getFieldValue('VAR')];
  ...
  typeblock: [{ translatedName: Blockly.Msg.LANG_LISTS_FILTEROVEREACH_INPUT_ITEM }]
};

Blockly.Blocks.['lists_sortOverEach'] = {
  // For each loop.
  category : 'Lists',
  helpUrl : Blockly.Msg.LANG_LISTS_SORTOVEREACH_HELPURL,
  init : function() {
    this.setColour(Blockly.LIST_CATEGORY_HUE);
    //this.setOutput(true, null);
    // [lyn, 10/07/13] Changed default name from "i" to "item"
    ...
    this.appendValueInput('LIST')
    .setCheck(Blockly.Blocks.Utilities.YailTypeToBlocklyType("list",Blockly.Blocks.Utilities.INPUT))
    .appendField(Blockly.Msg.LANG_LISTS_SORTOVEREACH_INPUT_ITEM)
    .appendField(Blockly.Msg.LANG_LISTS_SORTOVEREACH_INPUT_INLIST)
    .setAlign(Blockly.ALIGN_RIGHT);
    this.appendDummyInput('COMPARATOR')
    .appendField(Blockly.Msg.LANG_LISTS_SORTOVEREACH_INPUT_COMPARATOR)
    .appendField(new Blockly.FieldParameterFlydown(Blockly.Msg.LANG_LISTS_SORTOVEREACH_INPUT_ITEM1,
                                                   true, // name is editable
                                                   Blockly.FieldFlydown.DISPLAY_BELOW),
                 'VAR')
    .appendField(Blockly.Msg.LANG_LISTS_SORTOVEREACH_INPUT_AND)
    .appendField(new Blockly.FieldParameterFlydown(Blockly.Msg.LANG_LISTS_SORTOVEREACH_INPUT_ITEM2,
                                                   true, // name is editable
                                                   Blockly.FieldFlydown.DISPLAY_BELOW),
                 'VAR2')  
    .setAlign(Blockly.ALIGN_RIGHT);
    ...
    //this.setPreviousStatement(true);
    //this.setNextStatement(true);
    this.setTooltip(Blockly.Msg.LANG_LISTS_SORTOVEREACH_TOOLTIP);
  },
  // onchange: Blockly.WarningHandler.checkErrors,
  getVars: function() {
    return [this.getFieldValue('VAR')];
  ...
  typeblock: [{ translatedName: Blockly.Msg.LANG_LISTS_SORTOVEREACH_INPUT_ITEM }]
};
...
Blockly.Blocks.['lists_sort'] = {
  ...
  init : function() {
    ...
    this.appendValueInput('LIST')
        .setCheck(Blockly.Blocks.Utilities.YailTypeToBlocklyType("list",Blockly.Blocks.Utilities.INPUT))
        .appendField('sort ascending list')
        .appendField('list');
    this.setTooltip(Blockly.Msg.LANG_LISTS_SORT_TOOLTIP);
  },
  // onchange: Blockly.WarningHandler.checkErrors,
  typeblock: [{ translatedName: Blockly.Msg.LANG_LISTS_SORT_TITLE_SORT }]
};

Blockly.Blocks.['lists_reverse2'] = {
  // Make a copy of list.
  category : 'Lists',
  ...
  // onchange: Blockly.WarningHandler.checkErrors,
  typeblock: [{ translatedName: Blockly.Msg.LANG_LISTS_REVERSE_TITLE_SORT }]
};
...
Blockly.Blocks.['lists_reduceOverEach'] = {
  // For each loop.
  category : 'Lists',
  helpUrl : Blockly.Msg.LANG_LISTS_SORTOVEREACH_HELPURL,
  init : function() {
    ...
    this.appendValueInput('LIST')
    .setCheck(Blockly.Blocks.Utilities.YailTypeToBlocklyType("list",Blockly.Blocks.Utilities.INPUT))
    .appendField(Blockly.Msg.LANG_LISTS_REDUCEOVEREACH_INPUT_ITEM)
    .appendField(Blockly.Msg.LANG_LISTS_REDUCEOVEREACH_INPUT_INLIST)
    .setAlign(Blockly.ALIGN_RIGHT);
    this.appendValueInput('NULL')
    .appendField(Blockly.Msg.LANG_LISTS_REDUCEOVEREACH_INPUT_NULL)
    .setAlign(Blockly.ALIGN_RIGHT);
    this.appendDummyInput('COMBINE')
    .appendField(Blockly.Msg.LANG_LISTS_REDUCEOVEREACH_INPUT_COMBINE)
    .appendField(new Blockly.FieldParameterFlydown(Blockly.Msg.LANG_LISTS_REDUCEOVEREACH_INPUT_HEAD,
                                                   true, // name is editable
                                                   Blockly.FieldFlydown.DISPLAY_BELOW),
                 'VAR')
    .appendField(Blockly.Msg.LANG_LISTS_REDUCEOVEREACH_INPUT_AND)
    .appendField(new Blockly.FieldParameterFlydown(Blockly.Msg.LANG_LISTS_REDUCEOVEREACH_INPUT_ANSWER,
                                                   true, // name is editable
                                                   Blockly.FieldFlydown.DISPLAY_BELOW),
                 'ANSWER')  
    .setAlign(Blockly.ALIGN_RIGHT);
    ...
    //this.setPreviousStatement(true);
    //this.setNextStatement(true);
    this.setTooltip(Blockly.Msg.LANG_LISTS_REDUCEOVEREACH_TOOLTIP);
  },
  // onchange: Blockly.WarningHandler.checkErrors,
  getVars: function() {
    return [this.getFieldValue('VAR')];
  ...
  typeblock: [{ translatedName: Blockly.Msg.LANG_LISTS_REDUCEOVEREACH_INPUT_ITEM }]
};
